...
router.get("/balance", authorization_middleware_1.VerifyToken, transaction_controllers_1.GetBalance);
router.post("/topup", authorization_middleware_1.VerifyToken, transaction_validation_1.TopUpValidation, transaction_controllers_1.TopUp);
...
router.get("/transaction/history", authorization_middleware_1.VerifyToken, transaction_controllers_1.GetTransactionHistory);
